...
noble.once('stateChange', async (state) => {
  if (state === 'poweredOn') {
    await noble.startScanningAsync(['40EE1111-63EC-4B7F-8CE7-712EFD55B90E'], false);
  }
});
...
noble.on('discover', async (peripheral) => {
  ...
  const {characteristics} = await peripheral.discoverSomeServicesAndCharacteristicsAsync([], ["40ee222263ec4b7f8ce7712efd55b90e"])
